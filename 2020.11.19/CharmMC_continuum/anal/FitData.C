...
for (int i=0; i<chain.GetEntries();i++){
  chain.GetEntry(i);
  if(m_dsi>range0 && m_dsi<range1 && k3_id>0.5 && k4_id>0.2 && pi2_id<0.9  && TMath::Abs(mc_dsi)==431){
    mass->setVal(m_dsi);
...
*/
  ...
  cv->SaveAs("allPID_withMCtruth_noPst.pdf","pdf");
}
