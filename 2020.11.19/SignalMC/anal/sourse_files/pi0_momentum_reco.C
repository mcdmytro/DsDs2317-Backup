...
Float_t range0=0.15, range1=0.8;
...
frame->GetYaxis()->SetTitle("Events/6.5 MeV/c");
...
cv->SaveAs("../pdf_files/pi0_momentum_reco.pdf","pdf");
cv->SaveAs("../eps_files/pi0_momentum_reco.eps","eps");
}
