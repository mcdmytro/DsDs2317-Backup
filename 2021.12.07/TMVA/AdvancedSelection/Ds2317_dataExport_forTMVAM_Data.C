...
void Ds2317_dataExport_forTMVAM_Data(){
  gROOT->Reset();
  ...
  TChain chain("h1");
  chain.Add("../../../../DsDs2317-rootFiles/Data/Ds2317_BCS.root");

  Float_t
    m_ds17, hel_ds17, pst_ds17, c2_ds17, dgf_ds17, m_dsii, pst_dsii, cn_dsii, c2_dsii, dgf_dsii, cn_dsi, hel_phi, c2_pi0, dgf_pi0, p_pi0, egam1, egam2;
  ...
  TNtuple *Tree  = new TNtuple("Tree",  "All tree", "dm_ds17:pst_ds17:c2_ds17:pc2_ds17:pst_dsii:c2_dsii:pc2_dsii:pc2_pi0:p_pi0:c2_pi0:egam1:egam2:hel_phi");

  for (int i=0; i<chain.GetEntries(); i++){
    chain.GetEntry(i);
    Double_t m_var = m_ds17-m_dsii;
    if(m_var>r0_2317 && m_var<r1_2317 && cn_dsii!=2)
    Tree->Fill(m_var, pst_ds17, c2_ds17, TMath::Prob(c2_ds17, dgf_ds17), pst_dsii, c2_dsii, TMath::Prob(c2_dsii, dgf_dsii), TMath::Prob(c2_pi0, dgf_pi0), p_pi0, c2_pi0, egam1, egam2, TMath::Abs(hel_phi));
    }

  TFile *MyFile = new TFile("Data_Ds2317_forTMVA.root","RECREATE");
  Tree ->Write();
