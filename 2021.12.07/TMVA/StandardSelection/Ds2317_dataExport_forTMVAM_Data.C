...
void Ds2317_dataExport_forTMVAM_Data(){
  ...
  TNtuple *Tree  = new TNtuple("Tree",  "All tree", "dm_ds17:pst_ds17:hel_phi:pc2_ds17:pc2_dsii:pc2_pi0");

  for (int i=0; i<chain.GetEntries(); i++){
    chain.GetEntry(i);
    Double_t m_var = m_ds17-m_dsii;
    if(m_var>r0_2317 && m_var<r1_2317 && cn_dsii!=2)
      Tree->Fill(m_var, pst_ds17, TMath::Abs(hel_phi), TMath::Prob(c2_ds17, dgf_ds17), TMath::Prob(c2_dsii, dgf_dsii), TMath::Prob(c2_pi0, dgf_pi0));
    }
