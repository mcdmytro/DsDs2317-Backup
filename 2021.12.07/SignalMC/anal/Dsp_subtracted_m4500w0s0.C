...
void Dsp_subtracted_m4500w0s0(){
gROOT->Reset();
gSystem->Load("libRooFit");
Float_t range0=4.3, range1=4.8;
RooRealVar *mass = new RooRealVar("mass","",range0,range1);
TChain chain("h1");
chain.Add("../Ds2317inDs2317_m4500w0s0.root");
...
for (int i=0; i<chain.GetEntries();i++){
 ...
 cv->SaveAs("./pdf_files/SMC_DspinDs2317_subtracted_m4500w0s0.pdf","pdf");
}
