...
void Dsp_subtracted_m4273w56s1(){
gROOT->Reset();
gSystem->Load("libRooFit");
Float_t range0=4.25, range1=4.45;
RooRealVar *mass = new RooRealVar("mass","",range0,range1);
TChain chain("h1");
chain.Add("../Ds2317inDs2317_X4272-like-identical.root");
...
for (int i=0; i<chain.GetEntries();i++){
 ...
 cv->SaveAs("./pdf_files/SMC_DspinDs2317_subtracted_m4273w56s1.pdf","pdf");
}
