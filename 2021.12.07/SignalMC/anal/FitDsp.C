...
for (int i=0; i<chain.GetEntries();i++){
  chain.GetEntry(i);
  if((m_dsp-0.1922)>range0 && (m_dsp-0.1922)<range1 && TMath::Abs(hel_phi)>0.35 && hel_ds17<0.7 && (cn_dsii==1 || cn_dsii==3)){
