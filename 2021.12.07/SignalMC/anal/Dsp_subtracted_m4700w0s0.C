...
for (int i=0; i<chain.GetEntries();i++){
 ...
 frame->GetYaxis()->SetTitle("Entries / 8 MeV/c^{2}");
 ...
 cv->SaveAs("./pdf_files/SMC_DspinDs2317_subtracted_m4700w0s0.pdf","pdf");
}
