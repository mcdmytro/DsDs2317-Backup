...
void Dsp_subtracted_m4286w0s0(){
gROOT->Reset();
gSystem->Load("libRooFit");
Float_t range0=4.285, range1=4.295;
...
for (int i=0; i<chain.GetEntries();i++){
 ...
 frame->GetYaxis()->SetTitle("Entries / 0.1 MeV/c^{2}");
 ...
 cv->SaveAs("./pdf_files/SMC_DspinDs2317_subtracted_m4286w0s0.pdf","pdf");
}
