...
for (int i=0; i<chain.GetEntries();i++){
 ...
 frame->SetTitle("");
 frame->GetXaxis()->SetTitle("#DeltaM(D_{s0}*(2317)) [GeV/c^{2}]");
 frame->GetYaxis()->SetTitle("Events / 3.5 MeV");
...
cv->SaveAs("Data_Ds2317_optimized_ready.pdf","pdf");
}
