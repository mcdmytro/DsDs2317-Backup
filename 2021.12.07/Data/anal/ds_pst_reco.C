...
for (int i=0; i<chain.GetEntries();i++){
  chain.GetEntry(i);
  if(pst_dsii<range1 && pst_dsii>range0 && TMath::Abs(hel_phi)>0.35 && cn_dsii!=2 && TMath::Prob(c2_ds17, dgf_ds17)>0.001 && TMath::Prob(c2_dsii, dgf_dsii)>0.001 && TMath::Prob(c2_pi0, dgf_pi0)>0.01){
    x->setVal(pst_dsii);
