...
for (int i=0; i<chain.GetEntries();i++){
  ...
  RooRealVar *sig = new RooRealVar("Nsig", "", 0, 1E9);
  RooRealVar *bkg = new RooRealVar("Nbkg", "", 0, 1E9);
  ...
  cv->SaveAs("CMC_pi0_mass.pdf","pdf");
}
