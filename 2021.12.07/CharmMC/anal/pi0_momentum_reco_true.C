...
frame->GetYaxis()->SetTitle("Events/1 MeV/c");
...
TArrow *arr = new TArrow(0.15,3.5E2,0.15,0,0.03,"|>");
arr->SetAngle(40);
arr->SetLineWidth(2);
frame->addObject(arr);
...
cv->SaveAs("../CMC_pi0_momentum_reco_true.pdf","pdf");
}
