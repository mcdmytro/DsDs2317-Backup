...
cv->SetFrameBorderMode(0);
 ...
 Float_t m_ds17, mc_ds17, cn_dsii, mctr, hel_phi, hel_ds17, pst_ds17, c2_ds17, dgf_ds17, c2_dsii, dgf_dsii, c2_pi0, dgf_pi0, pst_dsii, m_dsii, hel_ds17;
...
for (int i=0; i<chain.GetEntries();i++){
  chain.GetEntry(i);
  if(pst_dsii<range1 && pst_dsii>range0 && TMath::Abs(mc_ds17)!=10431 && TMath::Abs(hel_phi)>0.35 && cn_dsii!=2 && TMath::Prob(c2_ds17, dgf_ds17)>0.001 && TMath::Prob(c2_dsii, dgf_dsii)>0.001 && TMath::Prob(c2_pi0, dgf_pi0)>0.01){
    x->setVal(pst_dsii);
...
frame->GetXaxis()->SetTitle("p*(D_{s}), (GeV/c)");
...
TArrow *arr = new TArrow(2.5,2.5E5,2.5,0,0.03,"|>");
arr->SetAngle(40);
arr->SetLineWidth(2);
frame->addObject(arr);
