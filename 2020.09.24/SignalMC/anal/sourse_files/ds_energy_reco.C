...
frame->GetXaxis()->SetTitle("E(D_{s}), (GeV/c)");
...
cv->SaveAs("../pdf_files/ds_energy_reco.pdf","pdf");
cv->SaveAs("../eps_files/ds_energy_reco.eps","eps");
}
