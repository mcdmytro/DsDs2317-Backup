...
namespace Belle {
  ...
  void User_reco::event ( BelleEvent* evptr, int* status ) {
    ...
    */
    ...
    double minegam=0.1;
    if(pi0_chi2<200 && pi0_asym<0.9 && ppi0>0.18 && egam0>minegam && egam1>minegam){
    new_pi0.push_back(pi0_fitted);
